...
import { legalFeaturesData, legalHerocardData, reatilSafety,retailTeamsData, TechonologyHeroData, techSaasData } from "src/constants/SolutionData";

export default function page() {
    return (<>
        <Hero data={TechonologyHeroData[0]} herocardData={legalHerocardData}>
