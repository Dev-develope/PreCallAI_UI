        ...
        <section className="py-16 px-6 text-center bg-white">
            ...
            <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                {cardData?.map((ele, index) => (
                    <div key={index} className="border border-purple-300 rounded-xl p-6 shadow-md">
                        <h3 className="text-xs bg-gradient-to-r from-purple-500 to-pink-500 bg-clip-text text-transparent">{ele.Heading}</h3>
                        <p className=" font-bold text-4xl bg-gradient-to-r from-purple-500 to-pink-500 bg-clip-text text-transparent mt-2">{ele.para1}</p>
