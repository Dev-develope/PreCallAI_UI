                ...
                <div className="min-h-[22rem] flex flex-co text-center justify-center items-center">
                    ...
                    <div className="d-flex flex-col justify-center items-center">
                        ...
                        <div className="mt-6 flex flex-wrap justify-center gap-3 sm:gap-4">
                            <CommonButton className="bg-purple-600 text-white text-xs sm:text-sm font-bold px-4 sm:px-6 py-2 sm:py-3 shadow-lg" title="Try it now for free!!!" />
                            <CommonButton className="bg-white text-black text-xs sm:text-sm font-bold px-4 sm:px-6 py-2 sm:py-3 shadow-lg" title="Book a demo" />
                        </div>
                    </div>
                </div>
            </div>
